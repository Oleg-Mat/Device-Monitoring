...
void Dialog::ReadFile()
{
    ...
    if(file.open(QIODevice::ReadOnly | QIODevice::Text))
    {
        ...
        file.close();
    }else QMessageBox::information(this,"Error", "File not open");
    ...
    for(int i = 0; i < elements.size(); i++)
    {
        ...
        for(int h = 0; h < childelements.size(); h++)
        {
            ...
            if(element.tagName()=="bios") { elementitem->setIcon(QIcon(":/resources/img/bios.png"));childelementitem->setIcon(QIcon(":/resources/img/bios.png"));}
            if(element.tagName()=="system") { elementitem->setIcon(QIcon(":/resources/img/system.png"));childelementitem->setIcon(QIcon(":/resources/img/system.png"));}
            if(element.tagName()=="baseboard") { elementitem->setIcon(QIcon(":/resources/img/baseboard.png"));childelementitem->setIcon(QIcon(":/resources/img/baseboard.png"));}
            if(element.tagName()=="chassis") { elementitem->setIcon(QIcon(":/resources/img/chassis.png"));childelementitem->setIcon(QIcon(":/resources/img/chassis.png"));;}
            if(element.tagName()=="processor") { elementitem->setIcon(QIcon(":/resources/img/processor.png"));childelementitem->setIcon(QIcon(":/resources/img/processor.png"));}
            if(element.tagName()=="memory") { elementitem->setIcon(QIcon(":/resources/img/memory.png"));childelementitem->setIcon(QIcon(":/resources/img/memory.png"));}
            if(element.tagName()=="pci_dev") { elementitem->setIcon(QIcon(":/resources/img/pci_dev.png"));childelementitem->setIcon(QIcon(":/resources/img/pci_dev.png"));}
            if(element.tagName()=="usb_dev") { elementitem->setIcon(QIcon(":/resources/img/usb_dev.png"));childelementitem->setIcon(QIcon(":/resources/img/usb_dev.png"));}
            if(element.tagName()=="storage") { elementitem->setIcon(QIcon(":/resources/img/storage.png"));childelementitem->setIcon(QIcon(":/resources/img/storage.png"));}
            if(element.tagName()=="host") { elementitem->setIcon(QIcon(":/resources/img/host.png"));childelementitem->setIcon(QIcon(":/resources/img/host.png"));}
            if(element.tagName()=="timestamp") { elementitem->setIcon(QIcon(":/resources/img/timestamp.png"));childelementitem->setIcon(QIcon(":/resources/img/timestamp.png"));}
            if(element.tagName()=="monitor") { elementitem->setIcon(QIcon(":/resources/img/monitor.png"));childelementitem->setIcon(QIcon(":/resources/img/monitor.png"));}
